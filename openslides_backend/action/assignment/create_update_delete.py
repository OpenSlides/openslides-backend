...
class AssignmentCreateAction(CreateAction):
    """
    Action to create an assignment.
    Includes auto-creation of agenda items.
    """
    ...
    def check_agenda_creation(self, flag: bool = None, meeting_id: int = None) -> bool:
        # For assignments this should always return True.
        return True
