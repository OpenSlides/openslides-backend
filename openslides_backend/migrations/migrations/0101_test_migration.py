...
# TODO: If the migrations become many this importing becomes tedious. To improve
# this we could use a list of class names and importing of all migration modules
# to find the most recent change for this class and import it as Prev[classname].
