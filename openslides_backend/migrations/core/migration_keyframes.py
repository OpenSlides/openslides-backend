...
class MigrationKeyframeAccessor:
    ...
    def _fetch_model(self, fqid: Fqid) -> RawKeyframeModel | None:
        """
    ...
    def get_model(self, fqid: Fqid) -> Model:
    ...
    def get_deleted_model(self, fqid: Fqid) -> Model:
    ...
    def get_model_ignore_deleted(self, fqid: Fqid) -> tuple[Model, bool]:
...
class MigrationKeyframeModifier(MigrationKeyframeAccessor):
    ...
    def _create_model(self, fqid: Fqid, model: Model) -> None:
        """Creates a new model"""
        raise NotImplementedError()

    def _update_model(self, fqid: Fqid, model: RawKeyframeModel) -> None:
        """Updates model"""
        raise NotImplementedError()
...
class InitialMigrationKeyframeModifier(MigrationKeyframeModifier):
    ...
    def __init__(
        ...
        super().__init__(connection, position, migration_index, next_position)
        self.models: dict[Fqid, Model] = {}
        self.deleted: dict[Fqid, bool] = {}
...
class DatabaseMigrationKeyframeModifier(MigrationKeyframeModifier):
    ...
    def __init__(
        ...
        self.model_store: dict[Fqid, RawKeyframeModel] = {}
