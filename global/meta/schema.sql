...
-- MODELS_YML_CHECKSUM = '427535cd2bdb51131d3df4c8cfb9d56e'
-- Type definitions
DO $$
BEGIN
...
CREATE TABLE IF NOT EXISTS personal_noteT (
    ...
    content_object_id_personal_note_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
...
CREATE TABLE IF NOT EXISTS agenda_itemT (
    ...
    content_object_id_agenda_item_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_agenda_item_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion_block' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_agenda_item_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'assignment' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_agenda_item_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'topic' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
...
CREATE TABLE IF NOT EXISTS list_of_speakersT (
    ...
    content_object_id varchar(100) NOT NULL,
    content_object_id_list_of_speakers_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_list_of_speakers_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion_block' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_list_of_speakers_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'assignment' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_list_of_speakers_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'topic' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_list_of_speakers_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'mediafile' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
...
CREATE TABLE IF NOT EXISTS pollT (
    ...
    content_object_id varchar(100) NOT NULL,
    content_object_id_poll_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_poll_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'assignment' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_poll_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'topic' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
...
CREATE TABLE IF NOT EXISTS optionT (
    ...
    content_object_id varchar(100),
    content_object_id_option_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_option_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'user' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_option_id integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'poll_candidate_list' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
...
CREATE TABLE IF NOT EXISTS mediafileT (
    ...
    owner_id_mediafile_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(owner_id, '/', 1) = 'meeting' THEN cast(split_part(owner_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    owner_id_mediafile_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(owner_id, '/', 1) = 'organization' THEN cast(split_part(owner_id, '/', 2) AS INTEGER) ELSE null END) STORED,
...
CREATE TABLE IF NOT EXISTS projectionT (
    ...
    content_object_id varchar(100) NOT NULL,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'meeting' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'mediafile' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'list_of_speakers' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'motion_block' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'assignment' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'agenda_item' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'topic' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'poll' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'projector_message' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
    content_object_id_projection_ids integer GENERATED ALWAYS AS (CASE WHEN split_part(content_object_id, '/', 1) = 'projector_countdown' THEN cast(split_part(content_object_id, '/', 2) AS INTEGER) ELSE null END) STORED,
...
(select array_agg(m.id) from meetingT m where m.present_user_ids = u.id) as is_present_in_meeting_ids,
(select array_agg(c.id) from committeeT c where c.manager_ids = u.id) as committee_management_ids,
...
(select array_agg(p.id) from pollT p where p.voted_ids = u.id) as poll_voted_ids,
...
(select array_agg(g.id) from groupT g where g.meeting_user_ids = m.id) as group_ids
...
(select array_agg(c1.id) from committeeT c1 where c1.forward_to_committee_ids = c.id) as receive_forwardings_from_committee_ids,
(select array_agg(o.id) from organization_tagT o where o.tagged_ids = c.id) as organization_tag_ids
FROM committeeT c;
...
(select array_agg(o.id) from organization_tagT o where o.tagged_ids = m.id) as organization_tag_ids,
(select p.id from projector_countdownT p where p.used_as_list_of_speakers_countdown_meeting_id = m.id) as list_of_speakers_countdown_id,
(select p.id from projector_countdownT p where p.used_as_poll_countdown_meeting_id = m.id) as poll_countdown_id,
...
(select array_agg(c.id) from chat_groupT c where c.read_group_ids = g.id) as read_chat_group_ids,
(select array_agg(c.id) from chat_groupT c where c.write_group_ids = g.id) as write_chat_group_ids
FROM groupT g;
...
(select array_agg(t.id) from tagT t where t.tagged_ids = a.id) as tag_ids,
...
(select array_agg(m.id) from mediafileT m where m.attachment_ids = t.id) as attachment_ids,
(select a.id from agenda_itemT a where a.content_object_id = t.id) as agenda_item_id,
(select l.id from list_of_speakersT l where l.content_object_id = t.id) as list_of_speakers_id,
...
(select array_agg(m1.id) from motionT m1 where m1.all_derived_motion_ids = m.id) as all_origin_ids,
(select array_agg(m1.id) from motionT m1 where m1.state_extension_reference_ids = m.id) as referenced_in_motion_state_extension_ids,
(select array_agg(m1.id) from motionT m1 where m1.recommendation_extension_reference_ids = m.id) as referenced_in_motion_recommendation_extension_ids,
(select array_agg(ms.id) from motion_submitterT ms where ms.motion_id = m.id) as submitter_ids,
(select array_agg(mu.id) from meeting_userT mu where mu.supported_motion_ids = m.id) as supporter_meeting_user_ids,
...
(select array_agg(t.id) from tagT t where t.tagged_ids = m.id) as tag_ids,
(select array_agg(m1.id) from mediafileT m1 where m1.attachment_ids = m.id) as attachment_ids,
(select array_agg(p.id) from projectionT p where p.content_object_id = m.id) as projection_ids,
...
(select array_agg(g.id) from groupT g where g.read_comment_section_ids = m.id) as read_group_ids,
(select array_agg(g.id) from groupT g where g.write_comment_section_ids = m.id) as write_group_ids
...
(select array_agg(ms.id) from motion_stateT ms where ms.next_state_ids = m.id) as previous_state_ids,
...
(select o.id from optionT o where o.used_as_global_option_in_poll_id = p.id) as global_option_id,
(select array_agg(g.id) from groupT g where g.poll_ids = p.id) as entitled_group_ids,
...
(select l.id from list_of_speakersT l where l.content_object_id = a.id) as list_of_speakers_id,
(select array_agg(t.id) from tagT t where t.tagged_ids = a.id) as tag_ids,
(select array_agg(m.id) from mediafileT m where m.attachment_ids = a.id) as attachment_ids,
(select array_agg(p.id) from projectionT p where p.content_object_id = a.id) as projection_ids
FROM assignmentT a;
...
(select o.id from optionT o where o.content_object_id = p.id) as option_id
FROM poll_candidate_listT p;


CREATE OR REPLACE VIEW mediafile AS SELECT *,
(select array_agg(g.id) from groupT g where g.mediafile_inherited_access_group_ids = m.id) as inherited_access_group_ids,
(select array_agg(g.id) from groupT g where g.mediafile_access_group_ids = m.id) as access_group_ids,
...
CREATE TABLE IF NOT EXISTS im_meeting_user_motionT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_committee_userT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_committee_committeeT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_meeting_userT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_group_meeting_userT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_group_mediafileT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_group_motion_comment_sectionT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_group_pollT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_motion_motionT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_motion_state_motion_stateT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_poll_userT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);


CREATE TABLE IF NOT EXISTS im_chat_group_groupT (
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY
);
...
ALTER TABLE organization_tagT ADD FOREIGN KEY(tagged_ids) REFERENCES meetingT(id);
...
ALTER TABLE personal_noteT ADD FOREIGN KEY(content_object_id_personal_note_ids) REFERENCES motionT(id);
ALTER TABLE personal_noteT ADD FOREIGN KEY(meeting_id) REFERENCES meetingT(id);

ALTER TABLE tagT ADD FOREIGN KEY(tagged_ids) REFERENCES motionT(id);
ALTER TABLE tagT ADD FOREIGN KEY(meeting_id) REFERENCES meetingT(id);

ALTER TABLE agenda_itemT ADD FOREIGN KEY(content_object_id_agenda_item_id) REFERENCES topicT(id);
...
ALTER TABLE list_of_speakersT ADD FOREIGN KEY(content_object_id_list_of_speakers_id) REFERENCES mediafileT(id);
...
ALTER TABLE motionT ADD FOREIGN KEY(state_extension_reference_ids) REFERENCES motionT(id);
ALTER TABLE motionT ADD FOREIGN KEY(recommendation_extension_reference_ids) REFERENCES motionT(id);
...
ALTER TABLE pollT ADD FOREIGN KEY(content_object_id_poll_ids) REFERENCES topicT(id);
...
ALTER TABLE optionT ADD FOREIGN KEY(content_object_id_option_id) REFERENCES poll_candidate_listT(id);
...
ALTER TABLE mediafileT ADD FOREIGN KEY(attachment_ids) REFERENCES assignmentT(id);
ALTER TABLE mediafileT ADD FOREIGN KEY(owner_id_mediafile_ids) REFERENCES organizationT(id);
...
ALTER TABLE projectionT ADD FOREIGN KEY(content_object_id_projection_ids) REFERENCES projector_countdownT(id);
...
nt:nt => meeting_user/supported_motion_ids:-> motion/supporter_meeting_user_ids
...
FIELD nGt:nt,nt => organization_tag/tagged_ids:-> committee/organization_tag_ids,meeting/organization_tag_ids
...
nt:nt => committee/manager_ids:-> user/committee_management_ids
nt:nt => committee/forward_to_committee_ids:-> committee/receive_forwardings_from_committee_ids
...
nt:nt => meeting/present_user_ids:-> user/is_present_in_meeting_ids
FIELD 1tR:1t => meeting/reference_projector_id:-> projector/used_as_reference_projector_meeting_id
SQL 1t:1tp => meeting/list_of_speakers_countdown_id:-> projector_countdown/used_as_list_of_speakers_countdown_meeting_id
SQL 1t:1tp => meeting/poll_countdown_id:-> projector_countdown/used_as_poll_countdown_meeting_id
...
nt:nt => group/meeting_user_ids:-> meeting_user/group_ids
...
nt:nt => group/mediafile_access_group_ids:-> mediafile/access_group_ids
nt:nt => group/mediafile_inherited_access_group_ids:-> mediafile/inherited_access_group_ids
nt:nt => group/read_comment_section_ids:-> motion_comment_section/read_group_ids
nt:nt => group/write_comment_section_ids:-> motion_comment_section/write_group_ids
...
nt:nt => group/poll_ids:-> poll/entitled_group_ids
...
FIELD 1Gt:nt => personal_note/content_object_id:-> motion/personal_note_ids
FIELD 1tR:nt => personal_note/meeting_id:-> meeting/personal_note_ids

FIELD nGt:nt,nt,nt => tag/tagged_ids:-> agenda_item/tag_ids,assignment/tag_ids,motion/tag_ids
FIELD 1tR:nt => tag/meeting_id:-> meeting/tag_ids

FIELD 1GtR:1t,1t,1t,1tR => agenda_item/content_object_id:-> motion/agenda_item_id,motion_block/agenda_item_id,assignment/agenda_item_id,topic/agenda_item_id
...
FIELD 1GtR:1tR,1tR,1tR,1tR,1t => list_of_speakers/content_object_id:-> motion/list_of_speakers_id,motion_block/list_of_speakers_id,assignment/list_of_speakers_id,topic/list_of_speakers_id,mediafile/list_of_speakers_id
...
SQL 1tR:1GtR => topic/agenda_item_id:-> agenda_item/content_object_id
SQL 1tR:1GtR => topic/list_of_speakers_id:-> list_of_speakers/content_object_id
...
nt:nt => motion/all_derived_motion_ids:-> motion/all_origin_ids
...
FIELD nGt:nt => motion/state_extension_reference_ids:-> motion/referenced_in_motion_state_extension_ids
SQL nt:nGt => motion/referenced_in_motion_state_extension_ids:-> motion/state_extension_reference_ids
FIELD nGt:nt => motion/recommendation_extension_reference_ids:-> motion/referenced_in_motion_recommendation_extension_ids
...
SQL 1tR:1GtR => motion/list_of_speakers_id:-> list_of_speakers/content_object_id
...
SQL 1tR:1GtR => motion_block/list_of_speakers_id:-> list_of_speakers/content_object_id
...
nt:nt => motion_state/next_state_ids:-> motion_state/previous_state_ids
...
FIELD 1GtR:nt,nt,nt => poll/content_object_id:-> motion/poll_ids,assignment/poll_ids,topic/poll_ids
SQL nt:1t => poll/option_ids:-> option/poll_id
SQL 1t:1tp => poll/global_option_id:-> option/used_as_global_option_in_poll_id
nt:nt => poll/voted_ids:-> user/poll_voted_ids
...
FIELD 1tp:1t => option/used_as_global_option_in_poll_id:-> poll/global_option_id
SQL nt:1tR => option/vote_ids:-> vote/option_id
FIELD 1Gt:nt,nt,1tR => option/content_object_id:-> motion/option_ids,user/option_ids,poll_candidate_list/option_id
...
SQL 1tR:1GtR => assignment/list_of_speakers_id:-> list_of_speakers/content_object_id
...
SQL 1tR:1Gt => poll_candidate_list/option_id:-> option/content_object_id
...
FIELD 1tp:1t => projector_countdown/used_as_list_of_speakers_countdown_meeting_id:-> meeting/list_of_speakers_countdown_id
FIELD 1tp:1t => projector_countdown/used_as_poll_countdown_meeting_id:-> meeting/poll_countdown_id
...
nt:nt => chat_group/read_group_ids:-> group/read_chat_group_ids
nt:nt => chat_group/write_group_ids:-> group/write_chat_group_ids
...
/*   Missing attribute handling for sql, reference, on_delete, equal_fields, primary */