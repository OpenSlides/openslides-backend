...
To decide whether to update an existing user with a row or to create a new one, the data is tried to match to the existing users analogously to the [`search_users` presenter](https://github.com/OpenSlides/OpenSlides/wiki/search_users#logic):
