...
class ResourceUploadActionTest(BaseActionTestCase):
    ...
    def test_upload_and_mixed_sep_actions(self) -> None:
        ...
        self.assertIn(
            "Datastore service sends HTTP 400. The following locks were broken: 'resource/1', 'organization/1/resource_ids', 'organization/1/resource_ids', 'resource/1/organization_id', 'resource/organization_id', 'resource/token'",
