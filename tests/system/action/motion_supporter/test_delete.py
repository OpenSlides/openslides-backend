...
class MotionSupporterDeleteActionTest(BaseActionTestCase):
    # TODO: Amend for new submitter format and actual correct delete payloads
    ...
    def test_meeting_support_system_deactivated(self) -> None:
        ...
        response = self.request(
            "motion_supporter.delete", {"motion_id": 1, "support": True}
        )
    ...
    def test_unsupport(self) -> None:
        ...
        response = self.request(
            "motion_supporter.delete", {"motion_id": 1, "support": False}
        )
