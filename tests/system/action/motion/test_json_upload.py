...
class MotionJsonUpload(BaseActionTestCase):
    ...
    def test_simple_create_with_reason_required(self) -> None:
        self.assert_simple_create(True)
    ...
    def test_simple_update_with_reason_required(self) -> None:
        self.assert_simple_update(True)
    ...
    def test_multi_row(self) -> None:
        ...
        simple_payload_addition = {
            ...
            "category_name": {"value": "", "info": ImportState.DONE},
    ...
    def test_update_with_foreign_meeting(self) -> None:
    ...
    def test_with_warnings(self) -> None:
        ...
        assert row["messages"] == [
            "Category could not be found",
            "Could not find at least one supporter: groupless",
        ...
        assert row["data"] == {
            ...
            "meeting_id": 10,
            "submitters_username": [
                {"value": "groupless", "info": ImportState.WARNING},
                {"value": "admin", "info": ImportState.GENERATED, "id": 1},
            ],
            "reason": {"value": "", "info": ImportState.DONE},
            "block": {"value": "", "info": ImportState.DONE},
