...
class SpeakerSortActionTest(BaseActionTestCase):
    def test_sort_correct_1(self) -> None:
        ...
        self.create_model(
            "speaker/31", {"list_of_speakers_id": 222, "name": "name_loisueb"}
        )
        self.create_model(
            "speaker/32", {"list_of_speakers_id": 222, "name": "name_blanumop"}
        )
    ...
    def test_sort_another_section_db(self) -> None:
        ...
        self.create_model(
            "speaker/33", {"list_of_speakers_id": 222, "name": "name_polusiem"}
        )
        response = self.client.post(
            "/",
            json=[
