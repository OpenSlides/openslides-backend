...
class SpeakerCreatePointOfOrderActionTest(BaseActionTestCase):
    def test_create_poo_after_talker(self) -> None:
        self.create_model(
            "meeting/7844",
            {
                "name": "name_asdewqasd",
        ...
        self.create_model(
            "speaker/3", {"user_id": 1, "list_of_speakers_id": 23, "weight": 10000}
        )
        self.create_model(
    ...
    def test_create_regular_besides_poo(self) -> None:
        ...
        self.assertEqual(speaker4["user_id"], 1)
        self.assertEqual(speaker4["weight"], 10000)
    ...
    def test_create_after_existing_poo(self) -> None:
        self.create_model(
            "meeting/7844",
            {
                "name": "name_asdewqasd",
    ...
    def test_create_after_existing_poo_at_the_end(self) -> None:
        self.create_model(
            "meeting/7844",
            {
                "name": "name_asdewqasd",
        ...
        list_of_speakers = self.get_model("list_of_speakers/23")
        self.assertListEqual(list_of_speakers["speaker_ids"], [1, 2, 3])
