...
class MeetingClone(BaseActionTestCase):
    ...
    def test_clone_with_settings(self) -> None:
        ...
        assignment_poll_settings = {
            "ballot_paper_selection": "number_of_delegates",
            "ballot_paper_number": 42,
    ...
    def test_clone_vote_delegated_vote(self) -> None:
        ...
        for poll_id in [1, 4]:
            self.create_motion(poll_id, poll_id)
            self.set_models(
                {
                    f"poll/{poll_id}": {
                    ...
                    f"poll_config_rating_approval/{poll_id}": {
        ...
        self.assert_model_exists(
            "user/1",
            {"meeting_user_ids": [1, 2, 3], "meeting_ids": [1, 4, 5]},
        )
        self.assert_model_exists(
            "meeting_user/3",
            {
