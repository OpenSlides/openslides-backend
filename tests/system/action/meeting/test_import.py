...
class MeetingImport(BaseActionTestCase):
        ...
        self.set_models(
            {
                ...
                "user/1": {"default_structure_level": "admin in meeting1", "structure_level_$": ["1"], "structure_level_$1": "story teller"},
    ...
    def test_replace_ids_and_write_to_datastore(self) -> None:
        ...
        user_2 = self.assert_model_exists(
            "user/2", {"username": "test", "group_$2_ids": [2], "group_$_ids": ["2"], "default_structure_level": "default boss", "structure_level_$": ["2"], "structure_level_$2": "meeting freak"}
        )
