...
class TestCheckDatabaseAll(BasePresenterTestCase):
    ...
    def get_meeting_defaults(self) -> dict[str, Any]:
        return {
            ...
            "motion_poll_default_required_majority": None,
            ...
            "assignment_poll_default_required_majority": None,
        ...
        self.set_models(
            {
                ...
                "gender/3": {"name": "diverse", "organization_id": 1},
                "gender/4": {"name": "non-binary", "organization_id": 1},
                "theme/1": {
                    "name": "Test Theme",
                    "accent_500": "#000000",
                    "primary_500": "#000000",
