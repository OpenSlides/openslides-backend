...
def test_delete_motion_without_sideffects_to_submodels(write, finalize, assert_model):
    ...
    write(
        ...
        },
        {
            "type": "create",
            "fqid": "motion_block/2",
            "fields": {"id": 2, "name": "AA", "meeting_id": 11, "motion_ids": [3]},
        },
        {
            "type": "create",
            "fqid": "mediafile/2",
        ...
        {
            "type": "create",
            "fqid": "motion_submitter/2",
            "fields": {"id": 2, "meeting_user_id": 1, "motion_id": 3, "meeting_id": 11},
        },
        {
            "type": "create",
            "fqid": "motion_editor/2",
            "fields": {"id": 2, "meeting_user_id": 1, "motion_id": 3},
        },
        {
            "type": "create",
            "fqid": "motion_working_group_speaker/2",
            "fields": {"id": 2, "meeting_user_id": 1, "motion_id": 3},
        },
        {
            "type": "create",
            "fqid": "motion_change_recommendation/2",
            "fields": {
                "id": 2,
                "line_from": 1,
                "line_to": 5,
        ...
        {
            "type": "create",
            "fqid": "structure_level_list_of_speakers/2",
            "fields": {
                "id": 2,
                "structure_level_id": 1,
                "list_of_speakers_id": 2,
        ...
        {
            "type": "create",
            "fqid": "point_of_order_category/2",
            "fields": {
                "id": 2,
                "text": "A point of order category",
                "speaker_ids": [2],
